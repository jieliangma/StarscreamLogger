...
public protocol Connection: HttpConnection {
    func write(data: Data, opcode: FrameOpCode)
}

public protocol HttpConnectionDelegate: AnyObject {
    func connection(_ connection: Connection, didReceive request: URLRequest)
}

public extension HttpConnectionDelegate {
    func connection(_ connection: Connection, didReceive request: URLRequest) {
        
    }
}

public protocol ConnectionDelegate: HttpConnectionDelegate {
...
public enum ServerEvent {
    ...
    case http(Connection, URLRequest)
}
